...
* the websites must use [PHP-FPM](https://blog.cpanel.com/how-to-use-php-fpm-with-cpanel/) handler.
...
#### Overview
In the _CloudLinux Manager → AccelerateWP_ tab Administrator has the opportunity to provide end-user with suites of features, which on its turn could be activated by end-user.
